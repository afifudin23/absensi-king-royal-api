...
const (
	EmploymentStatusPermanent  UserEmploymentStatus = "permanent"
	EmploymentStatusContract   UserEmploymentStatus = "contract"
	EmploymentStatusInternship UserEmploymentStatus = "internship"
	EmploymentStatusFreelance  UserEmploymentStatus = "freelance"
)
...
type UserProfile struct {
	...
	EmploymentStatus  *UserEmploymentStatus `gorm:"column:employment_status;type:enum('permanent','contract','internship','freelance');null"`
